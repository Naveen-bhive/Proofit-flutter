    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              icon:
                  const Icon(Icons.person_add_outlined, color: AppColors.brand),
      ...
      body: Column(children: [
        ...
        Expanded(
            child: state.isLoading
                ...
                : customers.isEmpty
                    ? EmptyState(
                        type: EmptyType.staff,
                        title: 'No customers yet',
                        subtitle:
                            'Add your first customer to start assigning jobs',

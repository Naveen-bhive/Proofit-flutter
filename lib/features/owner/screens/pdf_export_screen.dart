...
class _PdfExportScreenState extends ConsumerState<PdfExportScreen> {
  ...
  Future<void> _generatePdf() async {
    ...
    if (report.beforeDriveFileId != null) {
      beforeBytes =
          await DriveService.fetchPhotoBytes(report.beforeDriveFileId!);
    }
    ...
    final brand = PdfColor.fromHex('#2F80ED');
    ...
    pdf.addPage(pw.Page(
        ...
        build: (_) => pw.Column(
                ...
                children: [
                            ...
                            children: [
                              pw.Text('ProofIt',
                                  style: pw.TextStyle(
                                      ...
                                      color: brand)),
                              pw.Text('Work Done. Proved Instantly.',
                                  style:
                  ...
                  pw.Divider(color: brand, thickness: 2),
                      ...
                      child: pw.Column(
                          ...
                          children: [
                            ...
                            pw.Row(children: [
                              pw.Text('Staff:  ',
                                  style:
                                      pw.TextStyle(color: grey, fontSize: 11)),
                              pw.Text(report.staffName,
                                  style: pw.TextStyle(
                                      fontWeight: pw.FontWeight.bold,
                                      fontSize: 11)),
                            ...
                            if (report.location?.address != null)
                              pw.Row(children: [
                                ...
                                pw.Expanded(
                                    child: pw.Text(report.location!.address!,
                                        style: pw.TextStyle(
                                            fontWeight: pw.FontWeight.bold,
                                            fontSize: 11))),
                              ]),
                      ...
                      children: [
                                  ...
                                  child: pw.Center(
                                      child: pw.Text('BEFORE',
                                          style: pw.TextStyle(
                                              ...
                                              fontSize: 11)))),
                              if (beforeBytes != null)
                                pw.Image(pw.MemoryImage(beforeBytes),
                                ...
                                pw.Container(
                                    ...
                                    child: pw.Center(
                                        child: pw.Text('No photo',
                                            style: pw.TextStyle(color: grey)))),
                              pw.SizedBox(height: 6),
                              ..._mediaCaptionWidgets(
                                  report.beforeMedia, report.location, grey),
                            ])),
                        ...
                        pw.Expanded(
                            child: pw.Column(
                                  ...
                                  child: pw.Center(
                                      child: pw.Text('AFTER',
                                          style: pw.TextStyle(
                                              ...
                                              fontSize: 11)))),
                              if (afterBytes != null)
                                pw.Image(pw.MemoryImage(afterBytes),
                                    height: 200, fit: pw.BoxFit.cover)
                              else
                                pw.Container(
                                    height: 200,
                              ...
                              pw.SizedBox(height: 6),
                              ..._mediaCaptionWidgets(
                                  report.afterMedia, report.location, grey),
                            ])),
                      ]),
    ...
    return Scaffold(
      ...
      body: _generating
          ? Center(
              ...
              Text(_status,
                  style:
                      const TextStyle(color: AppColors.silver, fontSize: 14)),
            ]))
          : _pdfBytes == null
              ? Center(
                  child: Text(_status,
  ...
  List<pw.Widget> _mediaCaptionWidgets(
      MediaData? media, LocationData? fallback, PdfColor grey) {
    final lines = <String>[];
    if (media?.capturedAt != null) {
      lines.add(
          'Captured: ${DateFormat('d MMM yyyy, h:mm:ss a').format(media!.capturedAt!.toLocal())}');
    }
    ...
    return lines
        .map((line) => pw.Padding(
              ...
              child:
                  pw.Text(line, style: pw.TextStyle(fontSize: 8, color: grey)),
            ))
        .toList();
  }
}

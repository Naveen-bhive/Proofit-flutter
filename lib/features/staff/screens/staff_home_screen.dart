              ...
              sliver: SliverList(
                ...
                if (state.dailyTarget > 0) ...[
                      ...
                      children: [
                        const Text("Today's Target",
                            style: TextStyle(
                                color: AppColors.silver, fontSize: 13)),
                        Text(
                            '${state.submittedToday}/${state.dailyTarget} jobs',
                            style: const TextStyle(
                                color: AppColors.white,
                                fontWeight: FontWeight.w700)),
                      ]),
                  ...
                  ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                          value: (state.submittedToday / state.dailyTarget)
                              .clamp(0.0, 1.0),
                          backgroundColor: AppColors.dark3,
                          valueColor: AlwaysStoppedAnimation(
                              state.submittedToday >= state.dailyTarget
                                  ? AppColors.green
                                  : AppColors.brand),
                          minHeight: 10)),
                  const SizedBox(height: 16),
                ...
                if (state.todayLoading)
                  ...
                  EmptyState(
                      ...
                      actionLabel: 'View Assigned Jobs',
                      onAction: () => context.push('/staff/jobs'))
                else
                  ...state.todayReports.map((r) => ReportCard(
        ...
        child: Row(children: [
          Container(
              ...
              child: Icon(
                  ...
                  color: state.isCheckedIn ? AppColors.green : AppColors.muted,
                  size: 20)),
              ...
              child: Column(
                ...
                Text(state.isCheckedIn ? 'Checked In' : 'Not Checked In',
                    style: TextStyle(
                        ...
                        fontSize: 14)),
                Text(
                    state.isCheckedIn && state.checkInTime != null
          ...
          GestureDetector(
              onTap: () async {
                ...
                final allowed =
                    await AttendanceGates.allowCheckOut(context, ref);
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      color:
                          state.isCheckedIn ? AppColors.brand : AppColors.green,
  ...
  Widget _trackingHealthBanner(StaffState state) {
    ...
    switch (health) {
      ...
      case TrackingHealthStatus.batteryRisk:
        ...
        onAction = () async {
          if (!mounted) return;
          await BatteryOptimizationService.showFixGuide(context);
          if (!mounted) return;
          await ref
              .read(staffControllerProvider.notifier)
              .evaluateTrackingHealth();

...
class PhotoStampService {
  static Future<File> stampPhoto({
    ...
    // Logo-blue left border
    for (int y = bannerY; y < ih; y++) {
      for (int x = 0; x < 5; x++) {
        image.setPixel(x, y, ColorRgb8(47, 128, 237));
      }
    }
    ...
    for (int i = 0; i < lines.length; i++) {
      ...
      drawString(
        ...
        x: 14,
        y: textY,
        color: isTitle ? ColorRgb8(47, 128, 237) : ColorRgb8(255, 255, 255),
      );
      textY += isTitle ? 28 : 22;
    }
    ...
    drawString(
      ...
      x: iw - 90,
      y: 12,
      color: ColorRgb8(47, 128, 237),
    );

    final dir = await getTemporaryDirectory();
    final outPath =
        '${dir.path}/stamped_${capturedAt.millisecondsSinceEpoch}.jpg';

...
class ReportCard extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          ClipRRect(
            ...
            child:
                report.beforeMedia?.hasStoredPhoto == true && report.id != null
                    ? DrivePhotoWidget(
                        driveFileId: report.beforeMedia!.driveFileId,
                        reportId: report.id,
                        photoSlot: 'before',
                        width: 56,
                        height: 56,
              ...
              child: Column(
                ...
                Row(children: [
                  ...
                  Expanded(
                    ...
                    style:
                        const TextStyle(color: AppColors.silver, fontSize: 12),
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                  )),
                ]),
  ...
  Widget _placeholder() => Container(
        ...
        child:
            const Icon(Icons.image_outlined, color: AppColors.muted, size: 24),
      );
